public class Main {
    public static void main(String[] args) {
        ...
        СharacteristicsFacultie.comparingStudentsSlytherin(slytherins[0], slytherins[2]);
        СharacteristicsFacultie.comparingStudentsGryffindor(gryffindors[1], gryffindors[0]);
        СharacteristicsFacultie.comparingStudentsRavenclaw(ravenclaws[1],ravenclaws[2]);
        СharacteristicsFacultie.comparingStudentsHufflepuff(hufflepuffs[0], hufflepuffs[1]);
        printSeparator();
        System.out.println("Лучший ученик Хогвартса.");
        СharacteristicsFacultie.comparingStudentsHogwarts(hogwarts[0], hogwarts[3]);
    }
